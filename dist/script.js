...
var modals = function modals() {
  var bindModals = function bindModals(selModal, selBtn, selClose) {
    var giftStatus = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var modal = document.querySelector(selModal),
    ...
    var calcScroll = function calcScroll() {
      ...
      var scroll = document.body.offsetWidth - document.body.clientWidth;
      return scroll;
    };

    var scroll = calcScroll();

    var triggerButtons = function triggerButtons(selBtn) {
      var button = document.querySelectorAll(selBtn);
      button.forEach(function (item) {
        item.addEventListener('click', function (event) {
          ...
          if (e && e.matches(selBtn) || e && e === item.firstElementChild) {
    ...
    var modalWindow = function modalWindow(selClose, selModal) {
    ...
    var showModalByScroll = function showModalByScroll() {
      ...
      if (giftStatus && window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight) {
        openModal();
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  var changeSlideCounter = function changeSlideCounter() {
    if (slideCounter > items.length) {
      slideCounter = 1;
    }
  ...
  var activateAutoAnimation = function activateAutoAnimation() {
